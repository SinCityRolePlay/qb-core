...
QBConfig.Server.Discord = "https://discord.gg/YC6WGqQaVn" -- Discord invite link
QBConfig.Server.CheckDuplicateLicense = true -- Check for duplicate rockstar license on join
QBConfig.Server.Permissions = {'god', 'admin', 'mod', 'race'} -- Add as many groups as you want here after creating them in your server.cfg
